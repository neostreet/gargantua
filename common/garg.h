...
#define SPECIAL_MOVE_KINGSIDE_CASTLE          1
#define SPECIAL_MOVE_QUEENSIDE_CASTLE         2
#define SPECIAL_MOVE_CAPTURE                  3
#define SPECIAL_MOVE_EN_PASSANT               4
...
#define SPECIAL_MOVE_TWO_SQUARE_PAWN_ADVANCE 10
